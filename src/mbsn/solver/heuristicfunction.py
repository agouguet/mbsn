...
def heuristic_score_based(mdp, state, goal=None, previous_path=[], w1=1.0, w2=3.0, w3=0.1, w4=0.5, w5=1.0, debug=False, prev_actions=None, actions=None, ros_node = None):
